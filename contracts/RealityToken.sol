...
contract RealityToken {
    ...
    function createArbitratorWhitelist(address[] arbitrators) {
        arbitrator_whitelists[keccak256(arbitrators)] = arbitrators;
    }
    ...
    function RealityToken(address[] inital_funding_contracts)
    public {
    ...
    public returns (bytes32) {
        ...
        // You can't start adding windows in the future.
        uint256 max_window = (now - genesis_window_timestamp) / 86400; 
        ...
        BranchCreated(branch_hash,whitelist_id);
        return branch_hash;
    }
    ...
    public returns (bool) {
        ...
        Transfer(from_addr, addr_addr, NULL_HASH, NULL_HASH, amount, branch);
    ...
    public returns (bool) {
        ...
        Transfer(msg.sender, addr, from_box, to_box, amount, branch);
